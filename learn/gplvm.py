...
class GPLVM:
	...
	def __init__(self,Y,dim):
		...
		self.GP = GP.GP(X,Y, kernel=kernels.RBF(1.,1.))#choose particular kernel here if so desired.
...
if __name__=="__main__":
	...
	def plot_current():
		...
		pylab.scatter(myGPLVM.GP.X[:,0],np.zeros(N),40,colours)
