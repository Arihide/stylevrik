...
class IK_QPositionTask : public IK_QTask
{
  public:
	...
	void ComputeExpMapJacobian(IK_QJacobian &jacobian, const VectorXd &expmap);
...
class IK_QVelocityTask : public IK_QTask
{
  public:
	IK_QVelocityTask(
		bool primary,
	...
	void ComputeJacobian(IK_QJacobian &jacobian);
	void ComputeExpMapJacobian(IK_QJacobian &jacobian, const VectorXd &angvel);
